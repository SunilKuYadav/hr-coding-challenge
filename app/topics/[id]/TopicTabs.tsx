...
export default function TopicTabs({ overview, notes, patterns, mistakes }: TopicTabsProps) {
  ...
  return (
    <div>
      {/* Tab navigation */}
      <div className="flex border-b border-zinc-200 dark:border-zinc-700 mb-6" role="tablist">
        {TABS.map((tab) => (
          <button
            key={tab.key}
            role="tab"
